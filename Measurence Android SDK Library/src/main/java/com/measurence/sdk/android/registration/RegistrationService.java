...
public class RegistrationService extends IntentService {
    ...
    // TODO to be passed as parameters or such
    public static final String SENDER_ID = "1093814696074";
    public static final String APP_VERSION = "0.1-SNAPSHOT";

    public static final String log_prefix = "registration_id";
    ...
    public static final String api_subscription_path = "/api/android/apply_subscription";
    public static final String partner_id = "pslavazza";
    ...
    private void applyToApiSubscription(String user_identity) {
        ...
        String apiSubscriptionsRegistryHost = api_subscription_host;
        int  apiSubscriptionsRegistryPort = Integer.parseInt(api_subscription_port);
        String apiSubscriptionRegistryPath = api_subscription_path;
